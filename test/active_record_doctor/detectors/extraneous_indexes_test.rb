...
OUTPUT
  ...
  def test_include_index_covered_by_other_non_include_index
    ...
    assert_problems(<<OUTPUT)
remove index_users_on_last_name - can be replaced by index_users_on_last_name_and_first_name
OUTPUT
  end
  ...
  def test_include_index_covered_by_other_include_index
    ...
    assert_problems(<<OUTPUT)
remove index2_users_on_last_name - can be replaced by index1_users_on_last_name
OUTPUT
  end
